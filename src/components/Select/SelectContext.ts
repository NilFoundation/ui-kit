 ...
 */
export const createSelectContext = <T extends unknown>(): Context<SelectContextModel<T>> => createContext({} as SelectContextModel<T>);
 ...
 */
export const useSelectContext = <T extends unknown>(): SelectContextModel<T> => useContext(createSelectContext<T>());

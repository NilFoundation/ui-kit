...
To use, import the component `Modal, ModalHeader, ModalBody, ModalFooter, ModalButton, BUTTON_KIND` from `@nilfoundation/ui-kit`.
...
<Source
  ...
  code={`
        ...
        // Max modal's width is 500px
        <Modal isOpen={isOpen} onClose={() => setOpen(false)} size="default">
          Modal content
        </Modal>
  `}
/>

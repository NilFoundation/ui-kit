...
import { CandlestickSeries, LineSeries } from "./series";
...
export const TestComponent = () => {
  ...
  const [data, setData] = useState([{ time: "2020-10-" + dayCounter++, value: 0 }]);
  ...
  //     setF((f) => f + 1);
  //     setData((data) => [...data, { time: "2020-10-" + dayCounter++, value: f + 1 }]);
  //   }, 5000);
  //   return () => clearInterval(id);
  // }, [f]);

  // const onInit: ChartInitHandler = useCallback((chart) => {
  //   chart.timeScale().fitContent();
  // }, []);

  return (
    <div style={{ height: "600px", width: "90%" }}>
      <ChartWrapper onClick={onClick} rightPriceScale={{ visible: true }}>
        <LineSeries options={{ priceScaleId: "left" }} data={staticData} reactive />
        <CandlestickSeries data={candles} options={{ priceScaleId: "right" }} />
        <TimeScale visibleLogicalRange={range} onVisibleLogicalRangeChange={console.log} />
        <PriceScale
          id="left"
          options={{
            scaleMargins: {

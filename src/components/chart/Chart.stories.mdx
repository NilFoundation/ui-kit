...
import { LineSeries, CandlestickSeries, HistogramSeries, AreaSeries } from "lightweight-charts-react-components";
import { getFigmaParameters } from "../../shared/ui/getFigmaParameters";

<Meta title="Data display/Chart" component={Chart} />

export const Template = (args) => <Chart options={{ height: 400 }} {...args} />;
...
<Canvas isColumn>
  ...
  <Story
    name="Chart Widget"
    parameters={getFigmaParameters(
      "https://www.figma.com/file/YjE625ScDMf2ILjWB1sTMc/System?type=design&node-id=1839-62884&mode=design&t=HSeW4QjkrUj25Kdq-0"
    )}
  >
    <ChartWidget options={{ height: 106, width: 160 }} data={lineData} />
  </Story>

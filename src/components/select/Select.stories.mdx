...
<Canvas isColumn>
  ...
  <Story name="Without Searchable" args={{ options, placeholder: "Searchable Select", searchable: false, size: SELECT_SIZE.small }}>
    {Template.bind({})}
  </Story>
  <Story name="Without Default Value" args={{ options, placeholder: "With Default Value", value: [options[0]], size: SELECT_SIZE.small }}>
    {Template.bind({})}
  </Story>
</Canvas>

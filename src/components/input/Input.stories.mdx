...
<Canvas isColumn>
  ...
  <Story name="Loading" args={{ placeholder: "Loading...", size: INPUT_SIZE.small, isLoading: true, endEnhancer: <Search size="18px" /> }}>
      {Template.bind({})}
  </Story>
  ...
  <Story name="With End Enhancer" args={{ placeholder: "End Enhancer", endEnhancer: <Search size="18px" />, size: INPUT_SIZE.small }}>
      {Template.bind({})}
  </Story>
